...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #6b7280, #4b5563); padding: 40px; text-align: center; }
        ...
        .booking-card { background: #f9f9f9; border-radius: 12px; padding: 24px; margin: 24px 0; border-left: 4px solid #6b7280; }
        ...
        .total { background: #6b7280; color: white; border-radius: 12px; padding: 16px 24px; display: flex; justify-content: space-between; margin-top: 16px; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            <h2>¡Hola, {{ $userName }}! 👋</h2>
            <p>Tu reservación ha sido cancelada exitosamente. Aquí están los detalles:</p>
        ...
        <div class="footer">
            ...
            <p>Este correo fue enviado porque cancelaste una reservación en nuestra plataforma.</p>
        </div>
    </div>
</body>
</html>