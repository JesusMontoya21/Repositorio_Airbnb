...
export default function MyProperties() {
  ...
  const { data: properties, isLoading } = useQuery({
    ...
    queryFn: () => propertiesAPI.getMyProperties().then(res => res.data),
  });
              ...
              <div className="p-4">
                ...
                <div className="flex space-x-2">
                  <Link
                    ...
                    className="flex-1 text-center border border-primary text-primary px-4 py-2 rounded-lg hover:bg-primary hover:text-white transition"
                  >
                    Ver
                  </Link>
                  <button
